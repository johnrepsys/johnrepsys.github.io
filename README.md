...
| Resource | Link | Notes |
|----------|------|-------|
| **Paper (PDF)** | [`main.pdf`](https://raw.githubusercontent.com/johnrepsys/courtroom-model/master/paper/main.pdf) | *The Courtroom Challenge — Conjecture on the Unavoidable Cost of LLM Verification* |
